...
The number of goals scored by the home team is denoted as $y_{gh$} and for the away teams as $y_{gh$}. The notation g is the gth game in the season, or as in this example the gth game in the sample of games since the data set contains more than a full season. 
...
The samples of the parameters are obtained by Gibbs sampling. 

DAG representation of the model:

The two hyper-parameters in the model, mu and sigma, builds a latent structure and this structure is assumed to be representive for all the games played in a season. The use of the hyper-parameters is to determine the average scoring rate

JÄMFÖR med Baio and Biangiardo så det inte är för likt.
